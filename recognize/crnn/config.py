...
__C.NET_NAME = 'Mobilenet'
__C.SUBCLS_NAME = 'voxel_exemplars'
__C.ALPHABET = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-'
__C.TRAIN = edict()
# Adam, Momentum, RMS
__C.TRAIN.restore = 0
...
__C.TRAIN.SNAPSHOT_PREFIX = 'Mobilenet_crnn'
...
def get_log_dir(name):
    ...
    """
    log_dir = osp.abspath(\
        osp.join(__C.ROOT_DIR, 'logs', __C.LOG_DIR, name, strftime("%Y-%m-%d-%H-%M-%S", localtime())))
