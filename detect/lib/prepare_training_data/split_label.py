...
path = '/home/deeple/project/ctpn/text-detection-ctpn/data/rawdata'
gt_path = '/home/deeple/project/ctpn/text-detection-ctpn/data/gtlabel'
out_path = 're_image'
...
for file in files:
    ...
    gt_file = os.path.join(gt_path, 'gt' + stem + '.txt')
